      ...
      >
        ...
        <div className="relative z-10 w-full max-w-[1000px] mx-auto px-12 flex flex-col items-center text-center">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-[#E8621A] text-[11px] font-semibold tracking-[0.25em] uppercase">Company Profile</span>
            <span className="w-16 h-[1px] bg-[#E8621A]" />
          </div>
          ...
          <p className="text-white/70 text-[19px] leading-relaxed max-w-[680px] mb-12">
            Nigeria&apos;s foremost independent provider of commodities inspection, laboratory analysis,
            marine surveys, collateral management, and stock monitoring services.
          </p>
          ...
          <div className="mt-16 grid grid-cols-4 gap-0 w-full max-w-[800px] rounded-2xl overflow-hidden border border-white/10">
            {[
              ...
              <div
                ...
                style={{ background: i === 1 ? '#E8621A' : 'rgba(255,255,255,0.05)' }}
              >
                <div
                ...
                <div className="text-white/70 text-[11px] mt-1.5 tracking-wide">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
