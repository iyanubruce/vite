  ...
  return (
    <div className="grid grid-cols-2 gap-3 h-[460px]">
      <div className="overflow-hidden rounded-xl w-full h-full">
        <img src={images[0]} alt="" className="w-full h-full object-cover object-top" />
      </div>
...
function ServiceBlock({ service, index }: { service: ServiceData; index: number }) {
  ...
  const TextContent = () => (
    <div className="flex flex-col justify-center">
      ...
      <p className="text-gray-500 text-[15px] leading-relaxed mb-6">{service.description}</p>
      <ul className="flex flex-col gap-2.5 mb-8">
        {service.bulletPoints.map((point, i) => (
          <li key={i} className="flex items-start gap-3">
            ...
            <span className="text-gray-600 text-[14px] leading-relaxed">{point}</span>
          </li>
        ))}
      </ul>
      <Link
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section
        ...
        style={{ backgroundImage: "url('https://www.access-fulcrum.com/images/serviceImage1.jpg')" }}
      >
        ...
        <div className="relative z-10 text-center px-8 max-w-[760px] mx-auto">
          ...
          <p className="text-white/70 text-[17px] leading-relaxed">
            Independent Quantity &amp; Quality verification on a wide range of commodities wherever
        ...
        <div className="max-w-[1200px] mx-auto px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-white/50 text-[15px] leading-relaxed">
              Our team is ready to discuss your requirements and provide tailored inspection solutions.
            </p>
          </div>
            <Link
              href="/contact"
