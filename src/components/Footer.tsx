      ...
      <div className="max-w-[1200px] mx-auto px-8 py-16 grid grid-cols-1 lg:grid-cols-4 gap-12">
        ...
        <div className="lg:col-span-1">
          ...
          <p className="text-white/50 text-[13px] leading-relaxed mb-6">
            A leading worldwide independent provider of comprehensive
            commodities inspection, collateral management and stock monitoring
            services.
          </p>
          <div className="flex gap-3">
            {["ri-linkedin-fill", "ri-twitter-x-fill", "ri-mail-line"].map(
              (icon, i) => (
                <a
                  key={i}
                  href="#"
      ...
      <div className="border-t border-white/10">
        <div className="max-w-[1200px] mx-auto px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/30 text-[12px]">
            &copy; {new Date().getFullYear()} Access Fulcrum Limited. All rights
            reserved.
          </p>
