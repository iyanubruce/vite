...
export default function Slideshow() {
  ...
  const images = ["Welcome to the Access Fulcrum Limited Website...", "AFL - Passionate about Exceptional Customer Service Excellence...", "AFL - Passionate about Exceptional Customer Service Excellence..."];
