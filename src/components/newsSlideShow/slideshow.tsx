...
export default function Slideshow() {
  ...
  const images = ["Welcome to the Veritek Global Solutions Website...", "VGS - Passionate about Exceptional Customer Service Excellence...", "VGS - Passionate about Exceptional Customer Service Excellence..."];
