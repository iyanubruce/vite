  ...
  if (client.logo) {
    return (
      <div
        ...
        style={{ background: client.darkCard ? client.color : '#ffffff', border: client.darkCard ? 'none' : '1.5px solid #e8ecf0' }}
      ...
      >
        <img
          ...
          style={{ filter: client.darkCard ? 'brightness(1)' : 'grayscale(20%)' }}
        />
      </div>
    );
  }
...
export default function ClientsSection() {
  ...
  return (
    <section className="py-24 overflow-hidden" style={{ background: '#f4f6fa' }}>
      <div className="max-w-[1200px] mx-auto px-8 mb-14 text-center">
        ...
        <p className="text-gray-500 text-[15px] max-w-[560px] mx-auto leading-relaxed">
          We are proud to have partnered with leading metals, minerals, and energy companies across Nigeria and beyond.
        </p>
      </div>

      {/* Row 1 — scrolls left */}
      <div className="relative mb-6 overflow-hidden">
        <div ref={track1Ref} className="flex marquee-left" style={{ width: 'max-content' }}>
      ...
      <div className="relative overflow-hidden">
        <div ref={track2Ref} className="flex marquee-right" style={{ width: 'max-content' }}>
      ...
      <div className="max-w-[1200px] mx-auto px-8 mt-14 flex items-center justify-center">
        <div className="flex items-center gap-3 text-gray-400 text-[13px] font-medium">
          ...
          <span>11+ companies trust Access Fulcrum for independent inspection</span>
          <span className="w-16 h-[1px] bg-gray-300" />
        </div>
      </div>
    </section>
